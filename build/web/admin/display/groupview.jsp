        ...
        <div class="container-fluid">
            <div class="row">
                <div style="text-align:center;" border="2px" class="col-lg-8">
                    <h2 style="margin-left: 530px" class="divider-style"><span>Danh sách tổ</span></h2>
                </div>
            </div>
            <div>
                        ...
                        <table class="table table-bordered" >
                            <thead>
                                <tr style="background-color: #002046; color: whitesmoke">
                                    ...
                                    <td><h4 style="font-family:Tim New Rone;"><b>Tổ trưởng</b></h4></td>
                                    <td><h4 style="font-family:Tim New Rone;"><b>Xem thiết bị</b></h4></td>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${group}" var="g">
                                    <tr>
                                        <td>${g.id}</td>
                                        <td>${g.leader}</td>
                                        <td><a href="listmachinegroup?id=${g.id}">Xem</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
