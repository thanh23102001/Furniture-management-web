...
<html>
    <head>
        ...
        <title>Danh sách thiết bị trong kho</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div style="text-align:center;" border="2px" class="col-lg-10">
                    <h2 class="divider-style"><span>Danh sách thiết bị trong kho</span></h2>
                </div>
            </div>
            <div>
                <div class="row row-space">
                    <div class="col-lg-2">
                        <form action="listwarehouse" method="GET">
                            <h4>Tìm kiếm</h4>
                        ...
                        <table class="table table-bordered" >
                            <thead>
                                <tr style="background-color: #002046; color: whitesmoke">
                                    ...
                                    <td><h4 style="font-family:Tim New Rone;"><b>Thời gian trong kho</b></h4></td>
                                    <td><h4 style="font-family:Tim New Rone;"><b>Xem chi tiết</b></h4></td>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${requestScope.warehouse}" var="wh">
                                    <tr>
                                        <td>${wh.machinebuy.seri}</td>
                                        <td>${wh.machinebuy.name}</td>
                                        <td>${wh.machinebuy.model}</td>
                                        <td>${wh.machinebuy.bb.dateinput}</td>
                                        <td>${wh.usedDate} ngày</td>
                                        <td><a href="updatebuy?seri=${wh.machinebuy.seri}&action=2" value="${wh.machinebuy.seri}">Xem và sửa</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
