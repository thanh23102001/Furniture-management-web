    ...
    <body>
        ...
        <div class="container-fluid">
            <div>
                ...
                <form action="updatebuy?direct=${action}" method="POST">
                    <div class="container ">
                        <div class="row row-space">
                            <div class="col-md-4 offset-md-4">
                                <h3 >Xem hoặc sửa thông tin thiết bị</h3>
                                <br>
                                Thuộc mã hóa đơn
                                <br>
                                ...
                                Mã Seri
                                <br>
                                <input class="form-control" type="text" placeholder="Mã số khác nhau được in trên mỗi thiết bị" name="seri" value="${machinebuy.seri}" required/>
                                <br>
                                Tên thiết bị
                                <br>
                                <input class="form-control" type="text" name="name" value="${machinebuy.name}" required/>
                                <br>
                                Mã phiên bản
                                <br>
                                <input class="form-control" type="text" placeholder="Đời máy, dòng máy, mẫu thiết bị" name="model" value="${machinebuy.model}" required/>
                                <br>
                                Giá mua
                                <br>
                                <input class="form-control" type="number"  name="price" value="${machinebuy.price}"/>
                                <br>
                                Độ mới
                                <br>
                                <input class="form-control" type="number" min="1" max="100" placeholder="Từ 1 đến 100" name="newness" value="${machinebuy.newness}" required/>
                                <br>
                                Hạn khấu hao(năm)
                                <br>
                                <input class="form-control" type="number" name="depreciation" value="${machinebuy.depreciation}" required/>
                                <br>
                                <div style="margin-bottom: 10px">
                                    <input  class="btn btn-success" type="submit" value="Lưu thay đổi"/>
                                    
                                    <a href="delete?seri=${machinebuy.seri}&direct=${action}&bill_search=${bill_search}" class="btn btn-danger">Xóa</a>
                                    ...
                                    <c:if test="${action eq 2}">
                                        <a href="listwarehouse" class="btn btn-danger">Hủy</a>
                                    </c:if>

                                    <c:if test="${action eq 3}">
                                        <a href="listbillbuy/listbuy?bill_search=${bill_search}" class="btn btn-danger">Hủy</a>
                                    </c:if>

                                    <c:if test="${check eq true && action eq 2 }">
                                        <a href="moveto?seri=${machinebuy.seri}" class="btn btn-danger">Chuyển tới tổ</a>
                                    </c:if>
                                </div>
                            </div>
                        </div>
