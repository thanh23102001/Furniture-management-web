...
<html>
    ...
    <body>
        <header>
            <c:if test="${sessionScope.acc.roleac eq 2}">
                <nav class="navbar navbar-light navbar-expand-md navbar-fixed-top navigation-clean-button" style="background-color: rgb(255,255,255);">
                    <div class="container">
                         <div><a class="navbar-brand" href="#"><span style="color: #002046"><img style="width: 140px" src="assets\img\IMG_4875.PNG">DAT THANH</span> </a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button></div>
                        <div
                            ...
                            <ul class="nav navbar-nav nav-right">
                                ...
                                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#" style="color: #000000;">Danh sách</a>
                                    <div class="dropdown-menu" role="menu" style="background-color: rgb(255,255,255);">
                                        <a class="dropdown-item" role="presentation" href="/WebManager/staff/listmachine">Danh sách thiết bị bảo trì</a>
                                        <a class="dropdown-item" role="presentation" href="/WebManager/staff/listrequest">Danh sách yêu cầu</a>
                                    </div>
                                </li>
                                <li class="nav-item" role="presentation"><a class="nav-link" href="/WebManager/staff/addrequest" style="color: #000000;">Gửi yêu cầu</a></li>
                            </ul>
        ...
        <img style="height:600px" src="assets\img\nha-thong-minh-bang-cam-ung.jpg" alt="" width="100%"/>
