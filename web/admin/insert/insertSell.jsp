...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div>
                <form action="insertsell" method="POST">
                    <div class="container ">
                        <div class="row row-space">
                            <div class="col-md-4 offset-md-4">
                                <h3 >Nhập thông tin thiết bị bán ra</h3>
                                <br>
                                Thuộc mã hóa đơn
                                <br>
                                ...
                                <select class="form-control" name="seri_product">
                                    <c:forEach items="${seri}" var="sr">
                                        <option value="${sr.seri}">${sr.seri}</option>
                                    </c:forEach>
                                </select>
                                <br>
                                Đơn vị
                                ...
                                <select class="form-control" name="unit">
                                    <option value="false">Chiếc</option>
                                    <option value="true">Bộ</option>
                                </select>
                                <br>
                                Giá mua
                                <br>
                                ...
                                <div style="margin-bottom: 10px">
                                    <input  class="btn btn-success" type="submit" value="Thêm và nhập máy khác"/>
                                    <a href="listbillsell" class="btn btn-danger">Xong</a>
                                </div>
                            </div>
                        </div>
                    </div> 
