...
<html>
    ...
    <body>
        ...
        <form action="insertbillsell" method="POST">
            <div class="container ">
                <div class="row row-space">
                    <div class="col-md-4 offset-md-4">
                        <h3>Thêm hóa đơn thiết bị bán</h3>
                        <br>
                        Mã hóa đơn
                        <br>
                        <input class="form-control" type="text" name="id_billsell" value=""/>
                        <br>
                        Ngày bán
                        <br>
                        <input class="form-control" type="date" name="date_output" max="${datemax}">
                        <br>
                        Số tiền chưa nhận được
                        <br>
                        <input class="form-control" type="number" name="amount_owed" value=""/>
                        <br>
                        Người mua
                        <br>
                        ...
                        <div>
                            <input class="btn btn-success" type="submit" value="Thêm hóa đơn"/>
                        </div>
                    </div>
                </div>
            </div>
