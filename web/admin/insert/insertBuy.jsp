                    ...
                    <div class="container ">
                        <div class="row row-space">
                            <div class="col-md-4 offset-md-4">
                                ...
                                Thuộc mã hóa đơn
                                <br>
                                <select class="form-control" name="bill_id_new">
                                ...
                                Mã Seri
                                <br>
                                <input class="form-control" type="text" placeholder="Mã số khác nhau được in trên mỗi thiết bị" name="seri_product"/>
                                <br>
                                Tên thiết bị
                                <br>
                                <input class="form-control" type="text" name="name_machine"/>
                                <br>
                                Mã phiên bản
                                <br>
                                <input class="form-control" type="text" placeholder="Đời máy, dòng máy, mẫu thiết bị" name="model_machine"/>
                                <br>
                                Giá mua
                                <br>
                                <input class="form-control" type="number"  name="price_machine"/>
                                <br>
                                Độ mới
                                <br>
                                <input class="form-control" type="number" min="1" max="100" placeholder="Từ 1 đến 100" name="newness"/>
                                <br>
                                Hạn khấu hao(năm)
                                <br>
                                <input class="form-control" type="number" name="depreciation" value="${machinebuy.depreciation}"/>
                                <br>
                                <div style="margin-bottom: 10px">
                                    <input  class="btn btn-success" type="submit" value="Thêm và nhập máy mới"/>
                                    <a href="listbillbuy" class="btn btn-danger">Xong</a>
                                </div>
                            </div>
                        </div>
                    </div> 
