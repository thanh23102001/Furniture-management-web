...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div>
                <a href="insertbillbuy" role="button" class="btn btn-default" style="margin-left: 17%;width: 180px;">Thêm hóa đơn</a>
            </div>
            <div>
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${requestScope.buy}" var="b">
                                    <tr >
                                        ...
                                        <td>${b.bb.dateinput}</td>
                                        <td>${b.bb.prov.name}</td>
                                        <td><a href="updatebuy?seri=${b.seri}&action=1&bill_search=${bill_search}" value="${b.seri}">Xem và sửa</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            <tfoot>
