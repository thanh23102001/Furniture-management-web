        ...
        <div class="container-fluid">
            <div class="row">
                <div style="text-align:center;" border="2px" class="col-lg-10">
                    <h2 class="divider-style"><span>Danh sách hóa đơn bán</span></h2>
                </div>
            </div>
            <div>
            ...
            <div>
                <div class="row row-space">
                    <div class="col-lg-2">
                        <form action="listbillsell" method="GET" id="idpv">
                            <h4>Tìm kiếm</h4>
                            ...
                            <select name="buyer_id" style="width: 220px">
                                ...
                                <c:forEach items="${buyer}" var="be">
                                    <option value="${be.id}" ${bid eq be.id ? 'selected' : ""}> 
                                        ${be.name}
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="col-lg-10">
                        <table class="table table-bordered" >
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${billsell}" var="bs">
                                    <tr >
                                        <td>${bs.id}</td>
                                        <td>${bs.datesell}</td>
                                        <td>${bs.amountowed} vnd</td>
                                        <c:set var="total" value="${total + bs.amountowed}" />
                                        <td>${bs.total_money} vnd</td>
                                        <td>${bs.total_money - bs.amountowed} vnd</td>
                                        <td>${bs.quantity}</td>
                                        <td>${bs.buyer.name}</td>
                                        <td><a href="listbillsell/listsell?bill_id=${bs.id}">Xem</a></td>
                                        <td><a href="listbillsell/updatebillsell?bill_id=${bs.id}">Sửa</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            <tfoot>
