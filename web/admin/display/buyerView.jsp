        ...
        <div class="container-fluid">
            <div class="row">
                <div style="text-align:center;" border="2px" class="col-lg-10">
                    <h2 class="divider-style"><span>Danh sách người mua</span></h2>
                </div>
            </div>
            <div>
                <a href="insertbuyer" role="button" class="btn btn-danger" style="margin-left: 17%;width: 200px;">Thêm người mua mới</a>
            </div>
            <div>
                <div class="row row-space">
                    <div class="col-lg-2">
                        <form action="listbuyer" method="GET">
                            <h4>Tìm kiếm</h4>
                            <u>_________________________________</u>
                            <br>
                            Tên người mua
                            <br>
                            <input type="text" name="name" placeholder="Tìm tên nhà cung cấp" value="${name}"/>
                            <br>
                        ...
                        <table class="table table-bordered" >
                            <thead>
                                <tr style="background-color: #002046; color: whitesmoke">
                                    <td><h4 style="font-family:Tim New Rone;"><b>ID</b></h4></td>
                                    <td><h4 style="font-family:Tim New Rone;"><b>Tên người mua</b></h4></td>
                                    <td><h4 style="font-family:Tim New Rone;"><b>Địa chỉ</b></h4></td>
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${requestScope.buyer}" var="b">
                                    <tr >
                                        <td>${b.id}</td>
                                        <td>${b.name}</td>
                                        <td>${b.address}</td>
                                        <td>${b.debt} vnd</td>
                                        <c:set var="total" value="${total + b.debt}" />
                                        <td><a href="deletebuyer?id=${b.id}">Xóa</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td style="border-color: black; background-color: #002046; color: whitesmoke" colspan="2">Tổng tiền nợ</td>
                                    <td style="border-color: black" colspan="3" >${total} vnd</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
