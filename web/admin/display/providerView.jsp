        ...
        <div class="container-fluid">
            <div class="row">
                <div style="text-align:center;" border="2px" class="col-lg-10">
                    <h2 class="divider-style"><span>Danh sách nhà cung cấp</span></h2>
                </div>
            </div>
            <div>
                <a href="insertprovider" role="button" class="btn btn-danger" style="margin-left: 17%;width: 200px;">Thêm nhà cung cấp mới</a>
            </div>
            <div>
                <div class="row row-space">
                    <div class="col-lg-2">
                        <form action="listProvider" method="GET">
                            <h4>Tìm kiếm</h4>
                            <u>_________________________________</u>
                            <br>
                            Tên nhà cung cấp
                            <br>
                            <input type="text" name="providers_name" placeholder="Tìm tên nhà cung cấp" value="${provider_name}"/>
                            <br>
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${requestScope.provider}" var="p">
                                    <tr >
                                        ...
                                        <td>${p.address}</td>
                                        <td>${p.debt} vnd</td>
                                        <c:set var="total" value="${total + p.debt}" />
                                        <td><a href="deleteprovider?id=${p.id}">Xóa</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            <tfoot>
