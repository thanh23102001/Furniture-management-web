        ...
        <div class="container-fluid">
            <div class="row">
                <div style="text-align:center;" border="2px" class="col-lg-10">
                    <h2 class="divider-style"><span>Danh sách thiết bị bảo trì</span></h2>
                </div>
            </div>
            <div>
                <a href="listwarehouse"  role="button" class="btn btn-danger" style="margin-left: 17%;width: 180px;">Thêm thiết bị</a>
            </div>
            <div>
                <div class="row row-space">
                    <div class="col-lg-2">
                        <form action="listmachinegroup" method="GET" id="idpv">
                            <h4>Tìm kiếm</h4>
