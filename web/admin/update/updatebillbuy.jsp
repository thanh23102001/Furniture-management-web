...
<html>
    ...
    <body>
        ...
        <form action="updatebillbuy" method="POST">
            <div class="container ">
                <div class="row row-space">
                    <div class="col-md-4 offset-md-4">
                        ...
                        Mã hóa đơn
                        <br>
                        <input class="form-control" type="text" name="id_bill" value="${billbuy.id}" disabled="disabled" />
                        <br>
                        Ngày nhập hàng
                        <br>
                        <input class="form-control" type="date" name="date_input" max="${datemax}" value="${billbuy.dateinput}">
                        <br>
                        Số tiền chưa trả
                        <br>
                        <input class="form-control" type="number" name="amount_owed" value="${billbuy.amountowed}"/>
                        <br>
                        Nhà cung cấp
                        <br>
                        <select class="form-control" name="provider_id">
                            <c:forEach items="${provider}" var="pv">
                                <option value="${pv.id}" <c:if test="${pv.id eq billbuy.provider_id}">selected="selected"</c:if>>
                                    ${pv.name}
                                </option>
                            </c:forEach>
                        </select>
                        <p style="opacity: 70%">Nếu chưa có nhà cung cấp tương ứng, vào mục nhà cung cấp để thêm</p>
                        <div>
